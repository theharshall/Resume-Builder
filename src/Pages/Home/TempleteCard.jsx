...
const TempleteCard = ({ data, thumbnail, settemplate, updatetemplate, resumedataprops }) => {
  ...
  return (
    <>
     {/*main Content*/}
      <div style={{ margin: '2vh 1vw', height: 'auto', width: 'auto', position: 'relative' }}>
        <div>
          ...
          <img
            style={{
              ...
              opacity: isHovered ? 0.6 : 1, // Set opacity when hovered
            }}
          ...
          {isHovered && (
           ...
           <button
              ...
              className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-3 px-3 rounded"
              onClick={onSubmit}
              onMouseEnter={handleHover} // Handle hover enter event
              onMouseLeave={handleHoverExit} // Handle hover exit event
            >
