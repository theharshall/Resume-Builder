            ...
            <ul style={{ marginTop: '5vw' }}>
              <li
                className={`cursor-pointer border-black ${
                  activeComponent === 'personal' ? 'bg-blue-700 text-white' : 'bg-white text-black'
                }`}
              ...
              <li
                className={`cursor-pointer ${
                  activeComponent === 'education' ? 'bg-blue-700 text-white' : 'bg-white text-black'
                }`}
              ...
              <li
                className={`cursor-pointer ${
                  activeComponent === 'work' ? 'bg-blue-700 text-white' : 'bg-white text-black'
                }`}
