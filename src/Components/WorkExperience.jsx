  ...
  return (
    <>
      ...
      <div className="w-full lg:w-[55vw] lg:ml-[10vw] md:w-[70vw] md:ml-[15vw] sm:w-[100vw] justifty-center items-center mt-10">
        <Box>
          <Typography className="mt-4 font-bold text-2xl text-center md:text-1xl p-7" variant="h4">
          ...
          {experience.map((item, key) => (
            <div key={key}>
              ...
              {/* Main content */}
              <Card style={{ borderRadius: '5px', backgroundColor: 'rgb(255, 255, 255)', padding: '1vw 3vw',border: "1px solid" }}>
                ...
                {key === experience.length - 1 && (
                  <div style={{ marginTop: '2vh' }}>
                    <Button style={{ backgroundColor: 'blue', color: '#fff', marginLeft: '40%', width: '20%' }} type="submit" onClick={onSubmit}>
