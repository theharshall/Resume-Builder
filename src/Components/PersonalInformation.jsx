...
function PersonalInformation(props) {
  ...
  return (
    <>
      {/* Main content */}
      <div className="w-full lg:w-[55vw] lg:ml-[10vw] md:w-[70vw] md:ml-[15vw] sm:w-[100vw] justifty-center items-center mt-1 px-4 py-2" >
        <Typography
          className="mt-2 font-bold text-2xl text-center p-55 md:text-1xl"
          variant="h4"
        >
        ...
        <FormControl style={{ width: "100%", marginTop: "2vh" }}>
          ...
          <textarea
            style={{
              border: "1px solid gray",borderRadius: "5px",width: '100%',textAlign: 'left', paddingLeft: '20px',  paddingTop: '10px',  paddingBottom: '10px',resize: 'vertical', fontSize:'18px'
            }}
