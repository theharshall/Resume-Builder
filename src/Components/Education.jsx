  ...
  return (
    <>{/* Main content */}
      <div className="w-full lg:w-[55vw] lg:ml-[10vw] md:w-[80%] md:ml-[10%] sm:w-[100%] justifty-center items-center mt-10">
        <Typography className="mt-4 font-bold text-2xl text-center md:text-1xl p-10" variant="h4">
          <SchoolIcon /> Educational Information
        </Typography>

        {/* Card component */}
        <Card style={{ borderRadius: '5px', backgroundColor: 'rgb(255, 255, 255)', padding: "2vw 2vw", border: "1px solid"}}>
          {/* Input fields */}
          <Box className="grid grid-cols-1 sm:grid-cols-1 md:grid-col-1 lg:grid-cols-1 gap-4 mx-auto max-w-5xl">
            <TextField
              label='Type'
          ...
          <Box className="grid grid-cols-1 sm:grid-cols-1 md:grid-col-2 lg:grid-cols-1 gap-4 mx-auto max-w-5xl mt-4">
            <TextField
              label='University'
          ...
          <div style={{ marginTop: "2vw" }}>
            <Button style={{ marginLeft: "40%", backgroundColor: "blue", color: "#fff", width: "20%" }} type="submit" onClick={handleSubmit(onSubmit)}>
