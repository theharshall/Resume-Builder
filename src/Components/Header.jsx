...
function Header() {
  ...
  // Function to get dynamic classes for NavLink
  ...
  return (
    <>
      {/* Navigation */}
      <nav className="bg-white-800 border shadow-sm mt-2">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-5">
          {/* Logo */}
          <Link to="/templete" className="flex items-center bg-white p-2 opacity-100">
            ...
            <ul className="font-medium flex flex-col p-4 md:p-0 mt-4 md:flex-row md:space-x-8 md:mt-0 md:border-0">
              ...
              <li>
                <NavLink
                  ...
                  to="/templete"
                  className={({ isActive }) =>
                    `block py-2 pl-3 pr-4 md:border-0 md:p-0 transform-gpu ${getNavLinkClass(isActive)} text-lg hover:text-blue-500 `
                  }
